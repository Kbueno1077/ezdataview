...
export const benefits: IBenefit[] = [
  ...
  },
  {
    ...
    description:
      "Start building wealth today, no financial degree required. EzDataView makes investing accessible and straightforward.",
    bullets: [
      {
  ...
  },
  {
    ...
    description:
      "Your financial data deserves the best protection. Rest easy knowing EzDataView employs cutting-edge security measures.",
    bullets: [
      {
