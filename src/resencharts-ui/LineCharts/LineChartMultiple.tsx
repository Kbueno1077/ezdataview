...
const defaultData: DataSeries[] = [
  ...
  },
  {
    data: [
      ...
      { date: "2023-05-03", value: 4 },
      { date: "2023-05-04", value: 3.5 },
      { date: "2023-05-05", value: 4 },
      { date: "2023-05-06", value: 5 },
      { date: "2023-05-07", value: 4.5 },
      { date: "2023-05-08", value: 3 },
      { date: "2023-05-09", value: 3.5 },
    ],
    color: {
                ...
                <g key={dateIndex}>
                  {processedSeries.map((series, seriesIndex) => (
                    <path
                      ...
                      d={`M ${xScale(series.data[dateIndex].date)} ${yScale(
                ...
                <TooltipContent>
                  ...
                  {processedSeries.map((series, i) => (
                    <div key={i} className="text-gray-500 text-sm">
                      {series.data[dateIndex].value.toLocaleString("en-US")}
                    </div>
                  ))}
                </TooltipContent>
              </ClientTooltip>
